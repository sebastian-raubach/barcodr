...
public class AboutDialog extends BannerDialog
{
	...
	protected void createContent(Composite composite)
	{
		...
		name.setText(RB.getString(RB.APPLICATION_TITLE) + " (1.0)");
	...
	private void createLicensePart(TabFolder parent)
	{
		...
		LicenseFileComboViewer licenseFileComboViewer = new LicenseFileComboViewer(composite, SWT.NONE)
		{
			...
			protected LinkedHashMap<String, String> getLicenseData()
			{
				...
				result.put("Thumbnailator", "licenses/thumbnailator.txt");
				result.put("ZXing", "licenses/zxing.txt");
		...
		throws IOException
	{
		...
		if (Barcodr.WITHIN_JAR)
			br = new BufferedReader(new InputStreamReader(Barcodr.class.getResourceAsStream("/" + path), "UTF-8"));
		else
